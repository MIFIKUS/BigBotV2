...
def aghathions_list_opened() -> bool:
...
def fuses_list_opened() -> bool:
    ...
    screenshot_name = 'bots\\booster\\fuse\\imgs\\screenshots\\is_aghathions_fuses_list_opened.png'
    color = [245, 245, 245]
    area_of_screenshot = (390, 186, 391, 187)
...
def confirm_list_opened() -> bool:
    ...
    screenshot_name = 'bots\\booster\\fuse\\imgs\\screenshots\\is_aghathions_confirm_list_opened.png'
    color = [245, 245, 245]
    area_of_screenshot = (1120, 185, 1121, 186)
...
def no_more_fuse() -> bool:
    ...
    template_name = 'bots\\booster\\fuse\\imgs\\templates\\nomore_aghathion_fuses.png'
    screenshot_name = 'bots\\booster\\fuse\\imgs\\screenshots\\is_nomore_aghathion_fuses.png'
...
def repeat_available() -> bool:
    ...
    screenshot_name = 'bots\\booster\\fuse\\imgs\\screenshots\\is_show_all_available.png'
    area_of_screenshot = (930, 910, 1300, 990)
...
def confirm_red_available() -> bool:
    ...
    screenshot_name = 'bots\\booster\\fuse\\imgs\\screenshots\\is_exit_available.png'
    area_of_screenshot = (1195, 140, 1230, 175)
